...
export enum AdGenerationMessage {
    ...
    REGENERATION_STARTED = 'Image regeneration started',
    REGENERATION_COMPLETED = 'Image variation regenerated successfully',
    REGENERATION_FAILED = 'Failed to regenerate image variation',
}

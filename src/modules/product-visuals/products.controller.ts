...
import { ProductAnalysisResponse, ProductJsonResponse, ProductListResponse, ProductResponse } from '../../libs/types/product/product.type';
import { FILE_SIZE_LIMIT, FRONT_BACK_REFERENCE_IMAGES } from '../../libs/config';
